...
export const SqliteView: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <Header
        title="SQLite Database Studio"
        subtitle="Embedded relational SQLite 3 engine with live SQL query runner, schema inspector, and binary download"
        actions={
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5">
        <div className="p-4 bg-slate-900/90 border border-slate-800 rounded-xl space-y-1">
          ...
          <p className="text-base font-bold text-white font-mono">SQLite 3.x</p>
        ...
        <div className="p-4 bg-slate-900/90 border border-slate-800 rounded-xl space-y-1">
          ...
          <p className="text-base font-bold text-white font-mono">
            {loading || !stats ? 'Connecting...' : `${stats.fileSizeKb} KB`}
          </p>
          <p className="text-[11px] text-slate-400 truncate font-mono">
            data/microfinance.sqlite
          </p>
        </div>
        ...
        <div className="p-4 bg-slate-900/90 border border-slate-800 rounded-xl space-y-1">
          ...
          <p className="text-[11px] text-slate-400">Pre-seeded &amp; user records</p>
        </div>
      </div>
